...
public class AnimatedBar extends Thread {
     ...
     * 
     * 
     * @param target the target value for the animated bar
     * @param strengthBar the particiular progress bar to update
    */
    ...
    public void run() {
        ...
        while (current != target) {
            ...
            SwingUtilities.invokeLater(() -> {
                ...
                strengthBar.setString(String.valueOf((int)(next/smoothnessScale)));
            });
